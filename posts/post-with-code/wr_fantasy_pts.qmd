...
I've played fantasy football for a decade and have always wondered how ESPN (and Yahoo, Sleeper, etc.) make their fantasy projections week to week. Where are they getting their numbers? Where are they getting probabilities from? What makes them think that Bijan Robinson is going to score 16.3 points for me this week vs. D? Why does his projection go up that much (or that little) if Tyler Allgeir happens to be out injured? Perhaps we won't get a chance to peak inside of ESPN's crystal ball, but maybe we can try to build our own? 
...
We'll start by loading in directly relevant player statistics and depth chart information
